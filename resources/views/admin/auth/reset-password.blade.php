            ...
            <div class="form-outer text-center d-flex align-items-center">
                <div style="width:100%; max-width:600px;" id="form_area">
                    <div class="form-inner" id="2fax">
                        ...
                        <div class="logo text-uppercase"><small>Reset Password</small></div>
                        <p>Provide your new password details below.</p>
                        <div id="errmsg" style="color:#F00; text-align:center"></div>
                        <form method="get" class="text-left form-validate" onSubmit="reset_password(event)">
                            <input type="password" name="ne" style="display: none">
                            ...
                            <div class="form-group-material">
                                <label for="password"><span class="fa fa-lock"></span> Comfirm New Password</label>
                                <input id="confirm_password" type="password" autocomplete="off" required minlength="6" class="form-control">
                            </div>
                        ...
                        <a href="/admin/login" class="forgot-pass">Login</a>
