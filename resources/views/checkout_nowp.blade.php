...
@section('content')
    <div class="row py-5">
        ...
        <div class="col-12 col-md-7 order-1 order-md-0" id="payment_cal_path">
                    ...
                    <div id="express-checkout-element">
                        ...
                        <div id="payment_areas">
                            ...
                            <div class="payment_area nowp_parea">
                                <div class="choice-radio"><label for="choice_nowp"><input checked type="radio" autocomplete="off" name="choice" id="choice_nowp" value="nowp"><i></i>  <span><img src="/img/icons/npay.png"> {{ @$pagstn['nowpay_name'] }} 
                               <span style="font-size:12px"> @if($nowp_per_off > 0)
                                  ( {{$nowp_per_off}}% off )
                                @endif </span>
                                </span></label></div>
                                <div class="payment_body bag892" id="nowp-container">
                                    Click the button below to complete payment. This will redirect you to Nowpayments checkout page.  
            ...
            <div class="text-center mt-3"><button onclick="completePayment()" class="btn  btn-primary pay_btn py-3 px-4"> Complete Payment</button></div>
...
@push('js')
    ...
    <script>
        ...
        async function userAuthentication() {
            ...
            try {
                const res = await fetch('/nowpay-checkout-registration', {
                    method: 'POST',
                    headers: {
