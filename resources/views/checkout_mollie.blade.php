                    ...
                    <div id="express-checkout-element">
                        ...
                        <div id="payment_areas">
                            ...
                            <div class="payment_area nowp_parea">
                                <div class="choice-radio"><label for="choice_nowp"><input checked type="radio" autocomplete="off" name="choice" id="choice_nowp" value="nowp"><i></i>  <span> &nbsp; Mollie
                                </span></label></div>
                                <div class="payment_body bag892" id="nowp-container" style="flex-direction: column; gap:10px;">
                                    Click the button below to complete payment. This will redirect you to Mollie checkout page.  
...
@push('js')
    ...
    <script>
        ...
        const ITEM_TYPE = '{{ $quote ? 'quote' : 'ai' }}';
        ...
        async function userAuthentication() {
            ...
            try {
                const res = await fetch('/mollie-checkout-registration', {
                    method: 'POST',
                    headers: {
