...
<div class="row d-none" id="mm_cc_line">
    <div class="col-12 col-md-4 qfgroup">
        ...
        <input readonly type="text" id="vehicle_make632" name="vehicle_make" class=" validate-required" >
    </div>
    <div class="col-12 col-md-4 qfgroup">
        <label>Vehicle Model</label> <abbr title="Required">*</abbr>
        <input readonly type="text" id="vehicle_model756" name="vehicle_model" class="validate-required" >
    </div>
...
<div class=" row">
    ...
    <div class="date-row">
        <input autocomplete="off" required  type="number" class="date-input" id="dd" placeholder="DD" maxlength="2">
        <span class="date-line"></span>
        <input autocomplete="off" required type="number" class="date-input" id="mm" placeholder="MM" maxlength="2">
        <span class="date-line"></span>
        <input autocomplete="off"  required type="number" class="date-input" id="yyyy" placeholder="YYYY" maxlength="4">
    </div>
    <input autocomplete="off" type="hidden" name="date_of_birth" id="date_of_birth" value="">
    </div>
...
<div class="row" style="align-items: flex-end">
    <div class="col-6 col-md-6 qfgroup">
        ...
        <input placeholder="Postcode" type="text" autocomplete="off" id="postcode" name="postcode" class="form-control  validate-required text-uppercase">
    </div>
    <div class="col-6 col-md-6 qfgroup">
...
<div class="qfgroup d-none">
    ...
    <select onchange="setAddressTown()"  autocomplete="off" id="address" name="address" class="validate-requinred">
    </select>
...
<div class="qfgroup">
    ...
    <input type="text" autocomplete="off" id="occupation" name="occupation" class=" validate-required" >
</div>
...
<p class="cwp-input-wrapper mt-5 d-none" style="border:1px solid var( --e-global-color-primary );  border-radius:10px; padding: 10px 40px; max-width: 350px; display:flex; flex-direction: column; justify-content: center; align-items: center; gap:5px">
