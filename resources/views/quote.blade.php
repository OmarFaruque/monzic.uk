...
@push('css')
    ...
    <style>
        ...
        .woocommerce-page form .password-input input[type="password"] {
            ...
            /* Smooth transitions on hover or focus */
        ...
        .woocommerce-page form .password-input input[type="password"]:focus {
            border-color: #aaa;
            /* Darken border on hover/focus */
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
            /* Increase shadow depth on hover/focus */
        }
        ...
        .quick-btn {
            ...
            /* Makes sure the anchor behaves like a block element */
            width: 100px;
            /* Set a fixed width */
            height: 30px;
            /* Set a fixed height */
            ...
            /* Optional: If text is too long, it will end with '...' */
        }
        ...
        input[type="text"] {
            ...
            /* Change 'Roboto' to your desired font */
            font-size: 16px;
...
@section('content')
    ...
    <div id="content-full" class="grid xcontainer col-940  single-product">
        <div class="woocommerce">
            ...
            <div id="product-2233"
                class="cpw-product product type-product post-2233 status-publish first instock product_cat-uncategorized downloadable virtual sold-individually purchasable product-type-simple">
                ...
                <div class="woocommerce-product-gallery woocommerce-product-gallery--without-images woocommerce-product-gallery--columns-4 images"
                    ...
                    <div class="woocommerce-product-gallery__wrapper">
                        <div class="woocommerce-product-gallery__image--placeholder"><img
                                src="../../wp-content/uploads/woocommerce-placeholder-600x600.png"
                ...
                <div class="summary entry-summary">
                    ...
                    <form onsubmit="quoteForm(event)" class="cart" action="" method="post"
                        ...
                        <div class="qfmain">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-8 qfgroup">
                                    ...
                                    <input type="text" id="reg_number867x" name="reg_numberx">
                                    <input id="reg_number867" name="reg_number" type="hidden">
                                </div>
                                <div class="col-12 col-md-4">
                                    <a id="get_cars" class="find-car-btn"
                                        style="width:100%; box-sizing:border-box; height: var(--input-height);">Find Car</a>
                                </div>
                            </div>
                            <div class="row d-none" id="mm_cc_line">
                                <div class="col-12 col-md-4 qfgroup">
                                    <label>Vehicle Make</label> <abbr title="Required">*</abbr>
                                    <input readonly type="text" id="vehicle_make632" name="vehicle_make"
                                        class=" validate-required">
                                </div>
                                <div class="col-12 col-md-4 qfgroup">
                                    <label>Vehicle Model</label> <abbr title="Required">*</abbr>
                                    <input readonly type="text" id="vehicle_model756" name="vehicle_model"
                                        class="validate-required">
                                </div>
                                <div class="col-12 d-none col-md-4 qfgroup">
                                    <label>Engine CC</label>
                                    <input readonly type="text" id="engine_cc681" name="engine_cc" value="">
                                </div>
                            </div>
                            ...
                            <div class="qfgroup">
                                ...
                                <div class="row g-2 duration_type">
                                    <div class="col-4"><a id="hour_period_type" class="quick-btn active  quick"
                                            data-type="hours">Hours</a></div>
                                    <div class="col-4"><a class="quick-btn disabled quick" data-type="days">Days</a></div>
                                    <div class="col-4"><a class="quick-btn disabled quick" data-type="weeks">Weeks</a>
                                    </div>
                                </div>
                            ...
                            <div class="qfgroup">
                                ...
                                <div class="row g-2 duration_period">
                                    <div class="col-6 col-sm-3"><a class="quick-btn  disabled quick" data-period="1"> 1
                                            hour</a></div>
                                    <div class="col-6 col-sm-3"><a class="quick-btn active quick" data-period="3">3
                                            hours</a></div>
                                    <div class="col-6 col-sm-3"><a class="quick-btn disabled quick" data-period="5">5
                                            hours</a></div>
                                    <div class="col-6 col-sm-3"><a class="quick-btn disabled quick"
                                            data-period="o">Other</a></div>
                                </div>
                                <select id="duration_period" name="duration_period"
                                    class="validate-required d-none"></select>
                            </div>

                            <input name="start_date" id="start_date" type="hidden" required>
                            <input name="end_date" id="end_date" type="hidden" required>
                            <input name="start_time" id="start_time" type="hidden" required>
                            <input name="end_time" id="end_time" type="hidden" required>

                            <div class="qfgroup">
                                <label>Start date? </label> <abbr title="Required">*</abbr>
                                <select id="start_daten" name="start_daten" class="validate-required"
                                    autocomplete="off">
                                    <option value=""></option>
                                    @php
                                        $today = time();
                                        for ($i = 0; $i < 30; $i++) {
                                            ...
                                            if ($i == 0) {
                                                echo '<option data-class="immediate" value="' .
                                                    $dateValue .
                                                    'xx">Immediate Start</option>';
                                            }
                            ...
                            <div class="qfgroup" id="hh_mm_line">
                            ...
                            <div class="qfgroup">
                                ...
                                <select autocomplete="off" id="cover_reason" name="cover_reason"
                                    class=" validate-required">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-4 qfgroup">
                                    ...
                                    <input id="first_name556" name="first_name" class=" validate-required">
                                </div>
                                <div class="col-12 col-md-3 qfgroup">
                                    <label>Middle Name</label>
                                    <input id="middle_name517" name="middle_name">
                                </div>
                                <div class="col-12 col-md-3 qfgroup">
                                    <label>Last Name</label> <abbr title="Required">*</abbr>
                                    <input id="last_name386" name="last_name" class=" validate-required">
                                </div>
                            </div>
                            ...
                            <div class=" row">
                                <div class="col-12 col-md-6 qfgroup">
                                    ...
                                    <div class="date-row">
                                        <input autocomplete="off" required type="number" class="date-input"
                                            id="dd" placeholder="DD" maxlength="2">
                                        <span class="date-line"></span>
                                        <input autocomplete="off" required type="number" class="date-input"
                                            id="mm" placeholder="MM" maxlength="2">
                                        <span class="date-line"></span>
                                        <input autocomplete="off" required type="number" class="date-input"
                                            id="yyyy" placeholder="YYYY" maxlength="4">
                                    </div>
                                    <input autocomplete="off" type="hidden" name="date_of_birth" id="date_of_birth"
                                        value="">
                                </div>

                                <div class="col-12 col-md-6 qfgroup">
                                    <label>Contact number</label> <abbr title="Required">*</abbr>
                                    <input autocomplete="off" id="phone" name="phone" class="validate-requinred">
                            ...
                            <div class="row" style="align-items: flex-end">
                                <div class="col-6 col-md-6 qfgroup">
                                    ...
                                    <input placeholder="Postcode" type="text" autocomplete="off" id="postcode"
                                        name="postcode" class="form-control  validate-required text-uppercase">
                                </div>
                                <div class="col-6 col-md-6 qfgroup">
                                    <a onclick="searchAddress(event)" class="find-car-btn lookup-btn"
                                        style="width:100%; box-sizing:border-box; height: var(--input-height);">LOOK UP
                                        ADDRESS</a>
                                </div>
                            </div>
                            ...
                            <div class="qfgroup">
                                ...
                                <input type="text" autocomplete="off" id="occupation" name="occupation"
                                    class=" validate-required">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4 qfgroup">
                                    ...
                                    <select id="licence_type304" name="licence_type" class="validate-required">
                                        ...
                                        <option value="Full Northern Ireland">Full Northern Ireland</option>
                                        <option value="Full EU">Full EU</option>
                                        <option value="Full International">Full International</option>
                                        <option value="Automatic UK">Automatic UK</option>
                                    </select>
                                </div>
                                <div class="col-12 col-md-4 qfgroup">
                                    <label>Held Duration</label> <abbr title="Required">*</abbr>
                                    <select id="licence_held_duration384" name="licence_held_duration"
                                        class="validate-required">
                            ...
                            <div class="text-center">
                                ...
                                <div class="d-inline-block ">
                                    <p class="cwp-input-wrapper mt-5 d-none"
                                        style="border:1px solid var( --e-global-color-primary );  border-radius:10px; padding: 10px 40px; max-width: 350px; display:flex; flex-direction: column; justify-content: center; align-items: center; gap:5px">
                                        <span style="white-space: nowrap; font-size: 25px;">Total Price</span>
                                        <span style="border:none !important; padding-top:0px !important; font-size: 25px;"
                                            type="text" class="input-text amount cpw-input text">£<span
                                                id="cpw_val"></span></span>
                                    </p>
                                </div>

                                <div class="wc-stripe-clear"></div>

                                <div><button type="submit" name="add-to-cart" value="2233"
                                        class="single_add_to_cart_button sbutton button alt cpw-disabled"
                                        style="pointer-events: none;">Continue</button></div>
                    ...
                    <div class="product_meta">
                        ...
                        <span class="posted_in">Category: <a href="../../product-category/uncategorized/index.html"
            ...
            if (isValid) {
                ...
                if (year >= startYear && year <= endYear) {
                    ...
                    if (isDateInRange(date_n, startDate, endDate)) {
                        ...
                        if (year >= startYear) {
                            $(".date-row").after(
                                '<div class="form_error date_error">Date out of range - You are not old enough to use our services.</div>'
                                );
                        } else {
                            $(".date-row").after(
                                '<div class="form_error date_error">Date out of range - You are not elligible  to use our services.</div>'
                                );
                        }
                        return "";
                    }
